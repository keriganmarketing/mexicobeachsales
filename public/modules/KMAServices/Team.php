...
class Team {
            ...
            <?php foreach($team as $member){ ?>
                <div class="<?php echo $atts['item_class']; ?>" >
                    <div class="team-thumbnail">
                        <img v-lazy="'<?php echo $member->image['sizes']['thumbnail']; ?>'" class="img-fluid mx-auto mbn-2 rounded-circle border border-secondary" >
                    </div>
                    <div class="team-content flex-grow my-2">
                        <h3 class="mt-2 mb-0 display-4 text-primary"><?php echo $member->post_title; ?></h3>
                        <p class="team-title m-0 text-secondary text-uppercase"><?php echo $member->title; ?></p>
                        <?php if($member->phone != '') { ?>
                        <p class="m-0"><a class="text-primary" href="tel:<?php echo $member->phone; ?>" ><?php echo $member->phone; ?><?php echo $member->phone_ext; ?></a></p>
                        <?php } ?>
                    </div>
                    <div class="d-flex" >
                    ...
                    <?php } ?>
                    <?php if($member->email != '') { ?>    
                        <a class="btn btn-sm btn-secondary ml-1" href="mailto:<?php echo $member->email; ?>">email</a>
                    <?php } ?>
                    </div>
                </div>
            <?php } ?>
    ...
    public function addCustomFields($post)
    {
        ...
        $post->phone_ext = get_field('phone_ext', $post->ID);
