        ...
        <div class="container d-flex justify-content-center justify-content-md-between">
            <div class="text-center" >
                <?php if(get_theme_mod( 'custom_logo' )): ?>
                    <a class="logo d-flex flex-column mx-auto" href="/">
                        <img 
                            src="<?php echo e(esc_url( 
                                wp_get_attachment_image_url(
                                    get_theme_mod( 'custom_logo' ), 
                                    'full' 
                                ) )); ?>" 
                            alt="<?php echo e(get_bloginfo('name')); ?>"
                            class="img-fluid"
                        >
            ...
            <div class="flex-grow-1">
                <div class="contact-nav">
                    <a class="mail top-button" title="<?php echo e(get_field('email', 'option')); ?>" href="mailto:<?php echo e(get_field('email', 'option')); ?>"><i class="fa fa-envelope d-inline-block mx-2" aria-hidden="true"></i><span class="d-none d-lg-inline-block text-white oswald"><?php echo e(get_field('email', 'option')); ?></span></a>
                    <a class="call top-button" title="<?php echo e(get_field('phone', 'option')); ?>" href="tel:<?php echo e(get_field('phone', 'option')); ?>"><i class="fa fa-phone d-inline-block mx-2" aria-hidden="true"></i><span class="d-none d-lg-inline-block text-white oswald"><?php echo e(get_field('phone', 'option')); ?></span></a>
                ...
                <div class="main-navigation collapse navbar-collapse">
                    <main-menu 
                        v-bind:main-nav="<?php echo e(website_menu('main-navigation')); ?>" 
...
<div v-if="mobileMenuOpen" class="mobile-menu align-items-center" ref="mobileMenuContainer" v-bind:class="{ 'open': this.mobileMenuOpen }" >
    <mobile-menu 
        v-bind:mobile-nav="<?php echo e(website_menu('mobile-navigation')); ?>" 
        class="navbar-nav w-100 m-auto" 
        id="mobile-navigation-menu" 
    ></mobile-menu>
</div><?php /**PATH /home/forge/mexicobeachsales.com/public/themes/wordplate/views/partials/header.blade.php ENDPATH**/ ?>